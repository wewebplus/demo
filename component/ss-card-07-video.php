<div class="ss-card ss-card-07">
    <div class="text-content">
        <div class="text-container border-left-3 bcolor-01">
            <div class="title-wrapper">
                <a class="title p lg fw-400 color-03 h-color-01 mt-2" href="#">
    ...
    <div class="img-content">
        <div class="ss-img adaptive">
            ...
            <div class="tag-counts">
                ...
                <div class="tag-count">
                    <img src="public/assets/app/images/icon/video.png" alt="Image Icon" />
                    20
                </div>
            </div>
            <div class="icon-play">
