    ...
    <div class="tray-affix w100p" data-spy="affix" data-offset-top="200">
              ...
              <div id="nav-spy">
                <ul class="nav tray-nav" data-smoothscroll="-90">
                  <li class="active">
                    <a href="#spy1">
                      <span class="fa fa-edit fa-lg"></span> <?php echo $Array_Mod_Lang["txt:Head 05"][$_SESSION['Session_Admin_Language']]?></a>
                  </li>
                  <li>
                    <a href="#spy2">
                      <span class="fa fa-flag fa-lg"></span> <?php echo $Array_Mod_Lang["txt:Head 06"][$_SESSION['Session_Admin_Language']]?></a>
                  </li>
                </ul>
              </div>
