  ...
  if($ext == "xlsx" || $ext == "xls"){
    ...
    if(count($namedDataArray)>0){
      for($iix=$pageindexF;$iix<=$pageindexT;$iix++){
        ...
        $sql = "SELECT "._TABLE_THAIEMBASSY_."_ID AS ID FROM "._TABLE_THAIEMBASSY_." WHERE "._TABLE_THAIEMBASSY_."_IDCard = '".$IDCard."'";
        $z->sql($sql);
        $v = $z->row();
        $NumRow = $z->num();
        if($NumRow==0){
          $insert = array();
  				...
  				$insert[_TABLE_THAIEMBASSY_."_IDCard"] = "'".sql_safe($IDCard)."'";
  				$insert[_TABLE_THAIEMBASSY_."_Username"] = "'".sql_safe($Username)."'";
  				$insert[_TABLE_THAIEMBASSY_."_Password"] = "'".sql_safe(md5($Password))."'";
  				$insert[_TABLE_THAIEMBASSY_."_AName"] = "'".sql_safe($AName)."'";
  				$insert[_TABLE_THAIEMBASSY_."_Name"] = "'".sql_safe($FName)."'";
  				$insert[_TABLE_THAIEMBASSY_."_LName"] = "'".sql_safe($LName)."'";
          $insert[_TABLE_THAIEMBASSY_."_CompanyName"] = "''";
  				$insert[_TABLE_THAIEMBASSY_."_CreateDate"] = "NOW()";
  				$insert[_TABLE_THAIEMBASSY_."_Status"] = "'On'";
  				$insert[_TABLE_THAIEMBASSY_."_Position"] = "'".$Position."'";
  				$z = new __webctrl;
