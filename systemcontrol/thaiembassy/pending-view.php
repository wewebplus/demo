...
$PathUploadResFile = (isset($defaultdata[$Login_MenuID]["path"]["RESFILE"])?$defaultdata[$Login_MenuID]["path"]["RESFILE"]:_RELATIVE_TEMP_UPLOAD_);
$PathUploadResPicture = (isset($defaultdata[$Login_MenuID]["path"]["RESIMG"])?$defaultdata[$Login_MenuID]["path"]["RESIMG"]:_RELATIVE_TEMP_UPLOAD_);
    ...
    <div class="panel heading-border panel-primary">
      <div class="panel-body bg-light">
        ...
        <div class="section-divider mb40" id="spy1">
            <span><?php echo $Array_Mod_Lang["txt:Head Res 01"][$_SESSION['Session_Admin_Language']]?></span>
        </div>
            ...
            <span><?php echo $Array_Mod_Lang["txt:Head Res 02"][$_SESSION['Session_Admin_Language']]?></span>
        </div>
				<div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-6">
            ...
            <span><?php echo $Array_Mod_Lang["txt:Head Res 03"][$_SESSION['Session_Admin_Language']]?></span>
        </div>
				<div class="form-group">
					<div class="col-sm-6">
				...
				<div class="section-divider mt40" id="spy4">
				  <span><?php echo $Array_Mod_Lang["txt:Head Res 04"][$_SESSION['Session_Admin_Language']]?></span>
				</div>
				<?php
				// echo '<pre>';
				...
				<div class="section-divider mt40" id="spy5">
				  <span><?php echo $Array_Mod_Lang["txt:Head Res 05"][$_SESSION['Session_Admin_Language']]?></span>
				</div>
				<?php
				...
				<div class="form-group">
					...
					<div class="col-md-4 frmalert">
						...
						if(!empty($InEstimatedPrice)){
							...
							$EstimatedName = $DataArrEstimatedPrice[array_key_first($mydata)]["Name"];
							echo $EstimatedName;
						}
						echo '</p>';
						?>
				...
				<div class="section-divider mt40" id="spy6">
				  <span><?php echo $Array_Mod_Lang["txt:Head Res 06"][$_SESSION['Session_Admin_Language']]?></span>
				</div>
