...
<div class="scoreform">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td class="NoDetail">4. คุณภาพอาหาร    (15 คะแนน)</td>
      ...
      <tr>
        <td colspan="5">
          ...
          <ul>
            <li>รายการอาหารไทย ร้อยละ 91 - 100 ได้รับ  5 คะแนน</li>
      ...
      <tr>
        <td class="NoDetail">6. การนำเสนอ    อาหาร   (5 คะแนน)</td>
  ...
  <table>
    ...
    <tbody>
      <tr>
        <td class="NoDetail">7. พ่อครัว/แม่ครัว     (10 คะแนน)</td>
      ...
      <tr>
        <td class="NoDetail">8. การตกแต่งร้าน     (5 คะแนน)</td>
      ...
      <tr>
        <td class="NoDetail">9. คุณภาพด้านการบริการ    (5 คะแนน)</td>
    ...
    <tfoot>
      <tr>
        ...
        <td class="FullScore">20</td>
        <td class="Score view"><?php echo $_Section3Total?></td>
        <td></td>
      </tr>
      <tr>
        <td colspan="2">รวมคะแนนส่วนที่ 2 และ 3 (ข้อ 1 - 9)</td>
        <td class="FullScore">100</td>
        <td class="Score view"><?php echo $_SectionTotalAll?></td>
        <td></td>
      </tr>
    </tfoot>
  </table>
    ...
    <div class="col-md-10">
      <div class="bs-component">
        <div class="radio-custom mb10">
          <input disabled type="radio" id="radioPassTheCriteria_CasualP" name="PassTheCriteria" <?php echo ($_PassTheCriteria=='P'?'checked="checked"':'')?> value="P">
          <label for="radioPassTheCriteria_CasualP">ผ่านเกณฑ์ และได้คะแนนตั้งแต่ 75 คะแนนขึ้นไป ได้รับตรา <span class="ColorCasual">Thai SELECT Casual</span> </label>
        </div>
        <div class="radio-custom mb10">
