    ...
    <div class="col-md-10">
      <div class="bs-component">
        <div class="radio-custom mb10">
          <input disabled type="radio" id="radioPassTheCriteria_ClassicP" name="PassTheCriteria" <?php echo ($_PassTheCriteria=='P'?'checked="checked"':'')?> value="P">
