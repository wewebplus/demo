jQuery(document).ready(function() {
  ...
  $("#treegrid").fancytree({
    ...
    source: {
      // url: "http://localhost/disaster2021/upload/frontmenu/resultsmenu-backend.json"
      url: FullPath+'frontmenu/group-ajax-loadtree-json.php'
    },
    dnd: {
      autoExpandMS: 400,
      focusOnClick: true,
    ...
    renderColumns: function(event, data) {
      ...
      htmlaction += '<div class="divaction">';
        if(node.children){
          ...
          htmlaction += '<a href="javascript:void(0)" rev="" rel="'+node.key+'" class="relateicon" onclick="ManageMenuType(this)"><i class="fas fa-bars"></i></a>'          
        }
        htmlaction += '<a href="javascript:void(0)" rev="" rel="'+node.key+'" class="relateicon" onclick="AddTreeMenu(this)"><i class="fas fa-plus-circle"></i></a>'
