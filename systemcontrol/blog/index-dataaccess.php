...
switch($actiontype){
	case 'changethisstatus':
		...
		$sql = "SELECT "._TABLE_BLOG_."_Key AS myKey,"._TABLE_BLOG_."_ID AS ID,"._TABLE_BLOG_."_Status AS ListStatus FROM "._TABLE_BLOG_." WHERE "._TABLE_BLOG_."_ID = ".(int)$itemid;
		$z = new __webctrl;
		$z->sql($sql);
		$v = $z->row();
		$Row = $v[0];
	...
	break;case 'changeusestatushome':
		$itemid = $itemid;
		$StatusTo = $statusto;
		// $sql = "SELECT "._TABLE_BLOG_."_ID AS ID,"._TABLE_BLOG_."_StatusHome AS ListStatus FROM "._TABLE_BLOG_." WHERE "._TABLE_BLOG_."_ID = ".(int)$itemid;
		// $z = new __webctrl;
		// $z->sql($sql);
		// $v = $z->row();
		// $Row = $v[0];
		$update = array();
		$update[_TABLE_BLOG_."_StatusHome"] = "'".$StatusTo."'";
		$update[_TABLE_BLOG_."_LastUpdate"] = "NOW()";
		$update[_TABLE_BLOG_."_UpdateByID"] = sql_safe($_SESSION['Session_Admin_ID'],false,true);
		$z = new __webctrl;
		$z->update(_TABLE_BLOG_,$update,array(_TABLE_BLOG_."_ID=" => $itemid));
  ...
  break;case 'changeuseRating':
    ...
    // echo $StatusType;
    $update = array();
		$update[_TABLE_BLOG_."_StatusRating"] = "'".$StatusTo."'";
		$update[_TABLE_BLOG_."_LastUpdate"] = "NOW()";
		$update[_TABLE_BLOG_."_UpdateByID"] = sql_safe($_SESSION['Session_Admin_ID'],false,true);
		$z = new __webctrl;
		$z->update(_TABLE_BLOG_,$update,array(_TABLE_BLOG_."_ID=" => $itemid));
  ...
  break;case 'changeusebtnComment':
    ...
    // echo $StatusType;
    $update = array();
		$update[_TABLE_BLOG_."_StatusComment"] = "'".$StatusTo."'";
		$update[_TABLE_BLOG_."_LastUpdate"] = "NOW()";
		$update[_TABLE_BLOG_."_UpdateByID"] = sql_safe($_SESSION['Session_Admin_ID'],false,true);
		$z = new __webctrl;
		$z->update(_TABLE_BLOG_,$update,array(_TABLE_BLOG_."_ID=" => $itemid));
  ...
  break;case 'changeusebtnPin':
    ...
    // echo $StatusType;
    $update = array();
		$update[_TABLE_BLOG_."_Pin"] = "'".$StatusTo."'";
		$update[_TABLE_BLOG_."_LastUpdate"] = "NOW()";
		$update[_TABLE_BLOG_."_UpdateByID"] = sql_safe($_SESSION['Session_Admin_ID'],false,true);
		$z = new __webctrl;
		$z->update(_TABLE_BLOG_,$update,array(_TABLE_BLOG_."_ID=" => $itemid));
  ...
  break;case 'changeusebtnPublic':
    ...
    // echo $StatusType;
    $update = array();
		$update[_TABLE_BLOG_."_Public"] = "'".$StatusTo."'";
		$update[_TABLE_BLOG_."_LastUpdate"] = "NOW()";
		$update[_TABLE_BLOG_."_UpdateByID"] = sql_safe($_SESSION['Session_Admin_ID'],false,true);
		$z = new __webctrl;
		$z->update(_TABLE_BLOG_,$update,array(_TABLE_BLOG_."_ID=" => $itemid));
	...
	break;case 'delete':
		$itemid = $itemid;
		$sql = "SELECT "._TABLE_BLOG_."_Key AS myKey,"._TABLE_BLOG_."_Picture AS thumb,"._TABLE_BLOG_."_PictureHome AS thumbhome FROM "._TABLE_BLOG_." WHERE "._TABLE_BLOG_."_ID = ".(int)$itemid;
	  $z = new __webctrl;
	  $z->sql($sql);
	  $v = $z->row();
	  $row = $v[0];
    ...
    $PathFileAtt = $PathUploadFile.$itemid."/";
		...
		$sql = "SELECT "._TABLE_BLOG_DETAIL_."_HTMLFileName AS HTMLFileName FROM "._TABLE_BLOG_DETAIL_." WHERE "._TABLE_BLOG_DETAIL_."_ContentID = ".(int)$itemid;
		$z = new __webctrl;
		$z->sql($sql);
		$num = $z->num();
		$r = $z->row();
    ...
    if(is_file($unlinkfile)){unlink($unlinkfile);}
      ...
      if(is_file($unlinkfile)){unlink($unlinkfile);}
		...
		$z = new __webctrl;
		$z->del(_TABLE_BLOG_,array(_TABLE_BLOG_."_ID=" => (int)$itemid));
		$z->del(_TABLE_BLOG_DETAIL_,array(_TABLE_BLOG_DETAIL_."_ContentID=" => (int)$itemid));
		$z->del(_TABLE_BLOG_PHOTO_,array(_TABLE_BLOG_PHOTO_."_ContentID=" => (int)$itemid));
    $z->del(_TABLE_BLOG_FILE_,array(_TABLE_BLOG_FILE_."_ContentID=" => (int)$itemid));
		echo "OK";
	break;case 'sort':
		$myorder = $_POST['tsort'];
		...
		if($counArr>0){
			for($i=1;$i<$counArr;$i++){
				...
				if($value <> 'null'){
					$j = $counArr-$i;
					$update[_TABLE_BLOG_."_Order"] = sql_safe($j,false,true);
					$z = new __webctrl;
					$z->update(_TABLE_BLOG_,$update,array(_TABLE_BLOG_."_ID=" => (int)$value));
					unset($update);
				}
			}
		}
