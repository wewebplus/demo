...
// echo '<pre>'; print_r($_POST); exit;
  ...
  $inputOtherFile = (isset($_POST["inputOtherFile"]) && $_POST["inputOtherFile"] !='') ? $_POST["inputOtherFile"] : '';
...
*/
  ...
  $update[_TABLE_MEMBER_."_Other_DocumentFile_Txt"] = "'".sql_safe($inputOtherFile)."'";
