...
// _TABLE_MEMBER_FILE_
$ArrField = array();
$ArrField[] = _TABLE_MEMBER_FILE_."_ID AS ID";
$ArrField[] = _TABLE_MEMBER_FILE_."_ContentID AS ContentID";
$ArrField[] = _TABLE_MEMBER_FILE_."_Session AS Session";
$ArrField[] = _TABLE_MEMBER_FILE_."_Subject AS Subject";
$ArrField[] = _TABLE_MEMBER_FILE_."_FileName AS FileName";
$ArrField[] = _TABLE_MEMBER_FILE_."_FileType AS FileType";
$ArrField[] = _TABLE_MEMBER_FILE_."_Flag AS Flag";
$ArrField[] = _TABLE_MEMBER_FILE_."_AddIndex AS AddIndex";
$sql = "SELECT ".implode(",",$ArrField)." FROM "._TABLE_MEMBER_FILE_." WHERE 1 ";
$sql .=" AND "._TABLE_MEMBER_FILE_."_ContentID = ".(int)$ContentID;
$sql .=" AND "._TABLE_MEMBER_FILE_."_Flag = '".$myflag."'";
if($SessionID<>""){
  $sql .= " AND "._TABLE_MEMBER_FILE_."_Session='".$SessionID."'";
}
$sql .="  ORDER BY "._TABLE_MEMBER_FILE_."_Order ASC";
unset($ArrField);
// echo $sql;
// exit();
$z = new __webctrl;
