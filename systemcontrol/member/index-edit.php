...
$SubDistrict = (!empty($Row["SubDistrict"])?$Row["SubDistrict"]:0);
...
// print_r($subdistrictInfo);
if($subdistrictInfo->datacount>0){
  $SubDistrictName = $subdistrictInfo->data['Name'];
}else{
  $SubDistrictName = "";
}
$SessionID = "";
$saveDataFile_1 = encode_URL('Login_MenuID='.$Login_MenuID.'&ContentID='.$ID.'&itemid='.$ID.'&SessionID='.$SessionID.'&myflag=certificate_of_registration&actiontype=update');
$saveDataFile_2 = encode_URL('Login_MenuID='.$Login_MenuID.'&ContentID='.$ID.'&itemid='.$ID.'&SessionID='.$SessionID.'&myflag=tax_identification&actiontype=update');
$saveDataFile_3 = encode_URL('Login_MenuID='.$Login_MenuID.'&ContentID='.$ID.'&itemid='.$ID.'&SessionID='.$SessionID.'&myflag=product_certificate&actiontype=update');
$saveDataFile_4 = encode_URL('Login_MenuID='.$Login_MenuID.'&ContentID='.$ID.'&itemid='.$ID.'&SessionID='.$SessionID.'&myflag=product_quality&actiontype=update');
$saveDataFile_5 = encode_URL('Login_MenuID='.$Login_MenuID.'&ContentID='.$ID.'&itemid='.$ID.'&SessionID='.$SessionID.'&myflag=copyright_origin&actiontype=update');
$saveDataFile_6 = encode_URL('Login_MenuID='.$Login_MenuID.'&ContentID='.$ID.'&itemid='.$ID.'&SessionID='.$SessionID.'&myflag=company_location&actiontype=update');
$saveDataFile_7 = encode_URL('Login_MenuID='.$Login_MenuID.'&ContentID='.$ID.'&itemid='.$ID.'&SessionID='.$SessionID.'&myflag=other_file&actiontype=update');
?>
      ...
      <?php }else if($Row['MemberType'] == 'Company') { ?>
              ...
              echo '<label class="field select">';
                ...
                if($dataSubDistrict->datacount>0){
                  foreach($dataSubDistrict->data as $gk=>$gv){
                    echo '<option value="'.$gv["Code"].'" '.($SubDistrict==$gv["Code"]?'selected="selected"':'').'>'.$gv["Name"].'</option>';
                  }
                }
                echo '</select>';
                echo '<i class="arrow"></i>';
        ...
        <div class="form-group">
            ...
            <input type="text" name="<?php echo "inputTelephone"?>" class="gui-input" value="<?php echo $Row['Company_telephone']; ?>" placeholder="<?php echo $Array_Mod_Lang["txtinput:inputTelephone"][$_SESSION['Session_Admin_Language']]?>">
					...
					<div class="col-md-2">
            <input type="text" name="<?php echo "inputFax"?>" class="gui-input" value="<?php echo $Row['Company_fax']; ?>" placeholder="<?php echo $Array_Mod_Lang["txtinput:inputFax"][$_SESSION['Session_Admin_Language']]?>">
					</div>
					<label class="col-md-2 control-label"><?php echo $Array_Mod_Lang["txtinput:inputMobile"][$_SESSION['Session_Admin_Language']]?></label>
					<div class="col-md-2">
            <input type="text" name="<?php echo "inputMobile"?>" class="gui-input" value="<?php echo $Row['Company_mobile']; ?>" placeholder="<?php echo $Array_Mod_Lang["txtinput:inputMobile"][$_SESSION['Session_Admin_Language']]?>">
					</div>
				</div>
        ...
        <div class="form-group">
					<label class="col-md-2 control-label"><?php echo $Array_Mod_Lang["txtinput:inputEmail"][$_SESSION['Session_Admin_Language']]?></label>
					<div class="col-md-3">
            <input type="text" name="<?php echo "inputEmail"?>" class="gui-input" value="<?php echo $Row['Company_email']; ?>" placeholder="<?php echo $Array_Mod_Lang["txtinput:inputEmail"][$_SESSION['Session_Admin_Language']]?>">
					</div>
					<label class="col-md-3 control-label"><?php echo $Array_Mod_Lang["txtinput:inputWebsite"][$_SESSION['Session_Admin_Language']]?></label>
					<div class="col-md-4">
            <input type="text" name="<?php echo "inputWebsite"?>" class="gui-input" value="<?php echo $Row['Company_website']; ?>" placeholder="<?php echo $Array_Mod_Lang["txtinput:inputWebsite"][$_SESSION['Session_Admin_Language']]?>">
					</div>
				</div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-2">
            <input type="text" name="<?php echo "inputRegisteredCapital"?>" class="gui-input" value="<?php echo $Row['Registered_capital']; ?>" placeholder="<?php echo $Array_Mod_Lang["txtinput:inputRegisteredCapital"][$_SESSION['Session_Admin_Language']]?>">
					</div>
				</div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
            <input type="text" name="<?php echo "inputDitpMemberNo"?>" class="gui-input" value="<?php echo $Row['Ditp_member_no']; ?>" placeholder="<?php echo $Array_Mod_Lang["txtinput:inputTxtDitpMemberNo"][$_SESSION['Session_Admin_Language']]?>">
					</div>
				</div>
        <div class="form-group">
        ...
        <h4>1. list of documents required for the application (Please specify)</h4>
        <div class="showrecommend mb10"><span><?php echo "Copy of certificate of registration as a juristic person (Not older than 6 months)"?></span></div>
        <div class="form-group">
					<label class="col-md-2 control-label"> </label>
					<div class="col-md-10 mt10">
						<div class="bs-component">
							<?php
							$typeUpload = "certificate_of_registration";
        ...
        <div class="showrecommend mb10"><span><?php echo "Copy of the company tax identification card"?></span></div>
        <div class="form-group">
					<label class="col-md-2 control-label"> </label>
					<div class="col-md-10 mt10">
						<div class="bs-component">
							<?php
							$typeUpload = "tax_identification";
        ...
        <div class="showrecommend mb10"><span><?php echo "Copy of product standard certificate from relevant agencies (Such as ISO,GMP,HACCP,HALAL Etc.)"?></span></div>
        <div class="form-group">
					<label class="col-md-2 control-label"> </label>
					<div class="col-md-10 mt10">
						<div class="bs-component">
							<?php
							$typeUpload = "product_certificate";
        ...
        <div class="showrecommend mb10"><span><?php echo "(If the company does not produce the product itself) Copy of the certificate from the company that produces the product stating that the product has been manufactured together with a copy of the certificate of product quality standard from the relevant departments of the company that produces the product provided by the authorized signatory of the company producing the product and stamp company that produces the product"?></span></div>
        <div class="form-group">
					<label class="col-md-2 control-label"> </label>
					<div class="col-md-10 mt10">
						<div class="bs-component">
							<?php
							$typeUpload = "product_quality";
        ...
        <h4>2. Other documents for consideration(If any,Please specify)</h4>
        <div class="showrecommend mb10"><span><?php echo "Copy of patent copyright origin intellectual property rights"?></span></div>
        <div class="form-group">
					<label class="col-md-2 control-label"> </label>
					<div class="col-md-10 mt10">
						<div class="bs-component">
							<?php
							$typeUpload = "copyright_origin";
        ...
        <div class="showrecommend mb10"><span><?php echo "Company location map in the case of change of company location"?></span></div>
        <div class="form-group">
					<label class="col-md-2 control-label"> </label>
					<div class="col-md-10 mt10">
						<div class="bs-component">
							<?php
							$typeUpload = "company_location";
							echo '<input name="saveData'.$typeUpload.'" type="hidden" value="'.$saveDataFile_6.'" >';
							echo '<input name="PathAtt'.$typeUpload.'" type="hidden" value="'.$PathUploadFile.'" >';
							echo '<input name="UploadTo'.$typeUpload.'" type="hidden" value="'.$defaultdata[$Login_MenuID]["fileupload"].'" >';
							echo '<input name="UploadFileType'.$typeUpload.'" type="hidden" value="'.$defaultdata[$Login_MenuID]["filetype"].'" >';
							echo '<table class="boxuploadfile">';
        ...
        <div class="showrecommend mb10"><span><?php echo "Other (Please specify)"?></span></div>
        <div class="form-group">
					<label for="inputStandard" class="col-lg-2 control-label"><?php echo "Other"?></label>
					<div class="col-lg-9">
						<div class="bs-component">
							<?php
							echo '<input type="text" name="inputOtherFile" class="form-control" value="" placeholder="Other (Please specify)">';
							?>
						</div>
					</div>
				</div>
        <div class="form-group">
					...
					<div class="col-md-10 mt10">
						<div class="bs-component">
							<?php
							$typeUpload = "other_file";
							echo '<input name="saveData'.$typeUpload.'" type="hidden" value="'.$saveDataFile_7.'" >';
							echo '<input name="PathAtt'.$typeUpload.'" type="hidden" value="'.$PathUploadFile.'" >';
							echo '<input name="UploadTo'.$typeUpload.'" type="hidden" value="'.$defaultdata[$Login_MenuID]["fileupload"].'" >';
							echo '<input name="UploadFileType'.$typeUpload.'" type="hidden" value="'.$defaultdata[$Login_MenuID]["filetype"].'" >';
							echo '<table class="boxuploadfile">';
