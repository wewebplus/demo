...
$arrf[] = "a."._TABLE_MEMBER_."_Other_DocumentFile_Txt AS Other_DocumentFile_Txt";
...
$sql .= " WHERE "._TABLE_ADDRSUBDISTRICT_."_Code = ".(int)$SubDistrict;
unset($arrf);
$z = new __webctrl;
$z->sql($sql);
$v = $z->row();
  ...
  <div class="admin-form theme-primary">
    ...
    <?php }else if($Row['MemberType'] == 'Company') { ?>
        ...
        <div class="form-group">
					...
					<div class="col-md-6">
            <div class="bs-component">
              <p class="form-control-static text-muted"><?php echo $Row['Other_DocumentFile_Txt']; ?></p>
              <?php
