  ...
  <div class="admin-form theme-primary">
    <div class="panel heading-border panel-primary">
      <div class="panel-body bg-light">
        ...
        <div class="form-group">
          <label for="inputSelect" class="col-lg-2 control-label"><?php echo $Array_Mod_Lang["txtinput:inputTypeMember"][$_SESSION['Session_Admin_Language']]?></label>
          <div class="col-lg-3">
            <div class="bs-component">
              <?php
              if(count($arrMemberType)>0){
                echo '<input type="hidden" name="inputTypeMember" class="gui-input" value="">';
                echo '<select name="selectTypeMember" class="form-control">';
