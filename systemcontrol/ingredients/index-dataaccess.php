...
switch($actiontype){
	case 'changethisstatus':
		...
		$sql = "SELECT "._TABLE_INGREDIENTS_."_Key AS myKey,"._TABLE_INGREDIENTS_."_ID AS ID,"._TABLE_INGREDIENTS_."_Status AS ListStatus FROM "._TABLE_INGREDIENTS_." WHERE "._TABLE_INGREDIENTS_."_ID = ".(int)$itemid;
		$z = new __webctrl;
		$z->sql($sql);
		$v = $z->row();
		$Row = $v[0];
    $myKey = $Row["myKey"];
		...
		$update = array();
		$update[_TABLE_INGREDIENTS_."_Status"] = "'".$StatusTo."'";
		...
		$z = new __webctrl;
		$z->update(_TABLE_INGREDIENTS_,$update,array(_TABLE_INGREDIENTS_."_ID=" => $itemid));
		unset($update);
	...
	break;case 'changeusestatushome':
		$itemid = $itemid;
		$StatusTo = $statusto;
		// $sql = "SELECT "._TABLE_INGREDIENTS_."_ID AS ID,"._TABLE_INGREDIENTS_."_StatusHome AS ListStatus FROM "._TABLE_INGREDIENTS_." WHERE "._TABLE_INGREDIENTS_."_ID = ".(int)$itemid;
		// $z = new __webctrl;
		// $z->sql($sql);
		// $v = $z->row();
		// $Row = $v[0];
		$update = array();
		$update[_TABLE_INGREDIENTS_."_StatusHome"] = "'".$StatusTo."'";
		$update[_TABLE_INGREDIENTS_."_LastUpdate"] = "NOW()";
		$update[_TABLE_INGREDIENTS_."_UpdateByID"] = sql_safe($_SESSION['Session_Admin_ID'],false,true);
		$z = new __webctrl;
		$z->update(_TABLE_INGREDIENTS_,$update,array(_TABLE_INGREDIENTS_."_ID=" => $itemid));
  ...
  break;case 'changeuseRating':
    ...
    // echo $StatusType;
    $update = array();
		$update[_TABLE_INGREDIENTS_."_StatusRating"] = "'".$StatusTo."'";
		$update[_TABLE_INGREDIENTS_."_LastUpdate"] = "NOW()";
		$update[_TABLE_INGREDIENTS_."_UpdateByID"] = sql_safe($_SESSION['Session_Admin_ID'],false,true);
		$z = new __webctrl;
		$z->update(_TABLE_INGREDIENTS_,$update,array(_TABLE_INGREDIENTS_."_ID=" => $itemid));
  ...
  break;case 'changeusebtnComment':
    ...
    // echo $StatusType;
    $update = array();
		$update[_TABLE_INGREDIENTS_."_StatusComment"] = "'".$StatusTo."'";
		$update[_TABLE_INGREDIENTS_."_LastUpdate"] = "NOW()";
		$update[_TABLE_INGREDIENTS_."_UpdateByID"] = sql_safe($_SESSION['Session_Admin_ID'],false,true);
		$z = new __webctrl;
		$z->update(_TABLE_INGREDIENTS_,$update,array(_TABLE_INGREDIENTS_."_ID=" => $itemid));
  ...
  break;case 'changeusebtnPin':
    ...
    // echo $StatusType;
    $update = array();
		$update[_TABLE_INGREDIENTS_."_Pin"] = "'".$StatusTo."'";
		$update[_TABLE_INGREDIENTS_."_LastUpdate"] = "NOW()";
		$update[_TABLE_INGREDIENTS_."_UpdateByID"] = sql_safe($_SESSION['Session_Admin_ID'],false,true);
		$z = new __webctrl;
		$z->update(_TABLE_INGREDIENTS_,$update,array(_TABLE_INGREDIENTS_."_ID=" => $itemid));
  ...
  break;case 'changeusebtnPublic':
    ...
    // echo $StatusType;
    $update = array();
		$update[_TABLE_INGREDIENTS_."_Public"] = "'".$StatusTo."'";
		$update[_TABLE_INGREDIENTS_."_LastUpdate"] = "NOW()";
		$update[_TABLE_INGREDIENTS_."_UpdateByID"] = sql_safe($_SESSION['Session_Admin_ID'],false,true);
		$z = new __webctrl;
		$z->update(_TABLE_INGREDIENTS_,$update,array(_TABLE_INGREDIENTS_."_ID=" => $itemid));
	...
	break;case 'sort':
		...
		if($counArr>0){
			for($i=1;$i<$counArr;$i++){
				...
				if($value <> 'null'){
					$j = $counArr-$i;
					$update[_TABLE_INGREDIENTS_."_Order"] = sql_safe($j,false,true);
					$z = new __webctrl;
					$z->update(_TABLE_INGREDIENTS_,$update,array(_TABLE_INGREDIENTS_."_ID=" => (int)$value));
					unset($update);
				}
			}
		}
