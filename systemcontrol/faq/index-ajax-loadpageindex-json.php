...
$sql .= "("	;
	...
	$arrf[] = "a."._TABLE_FAQ_."_GID AS GroupID";
	...
	$arrf[] = "a."._TABLE_FAQ_."_Order AS ListOrder";
	$arrf[] = "a."._TABLE_FAQ_."_Start AS StartDate";
	$arrf[] = "a."._TABLE_FAQ_."_End AS EndDate";
  ...
  $arrf[] = "a."._TABLE_FAQ_."_Public AS ListPublic";
  $arrf[] = "a."._TABLE_FAQ_."_View AS ListCountView";
  $arrf[] = "a."._TABLE_FAQ_."_Comment AS ListCountComment";
  $arrf[] = $langkey."."._TABLE_FAQ_DETAIL_."_ID AS SubjectID".$langkey;
	$arrf[] = $langkey."."._TABLE_FAQ_DETAIL_."_Subject AS Subject".$langkey;
	$arrf[] = $langkey."."._TABLE_FAQ_DETAIL_."_Status AS Status".$langkey;
	$sql .= "SELECT  ".implode(',',$arrf)." FROM "._TABLE_FAQ_." a";
  $sql .= " INNER JOIN (";
    $arrjoinlang = array();
    $arrjoinlang[] = _TABLE_FAQ_DETAIL_."_ID";
    $arrjoinlang[] = _TABLE_FAQ_DETAIL_."_ContentID";
    $arrjoinlang[] = _TABLE_FAQ_DETAIL_."_Subject";
    $arrjoinlang[] = _TABLE_FAQ_DETAIL_."_Status";
    $sql .= "SELECT ".implode(',',$arrjoinlang)." FROM "._TABLE_FAQ_DETAIL_;
    $sql .= " WHERE "._TABLE_FAQ_DETAIL_."_Lang = '".$langkey."'";
    unset($arrjoinlang);
  $sql .= ") ".$langkey." ON (a."._TABLE_FAQ_."_ID = ".$langkey."."._TABLE_FAQ_DETAIL_."_ContentID)";
  $sql .= " WHERE a."._TABLE_FAQ_."_Key IN ('".implode("','",$dataModuleKey)."')";
	unset($arrf);
$sql .= ") TBmain";
$sql .= " WHERE 1";
if(!empty($dataGroup)){
