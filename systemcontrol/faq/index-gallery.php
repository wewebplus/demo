...
foreach($systemLang as $lkey=>$lval){
	...
	$arrf[] = $lkey."."._TABLE_INGREDIENTS_DETAIL_."_HTMLFileName AS HTMLFileName01".$lkey;
				...
				<div class="row">
					<div class="col-md-12">
						<div class="section">
							...
							<div class="Recommended">Recommended : extention file *.jpg picture size as <?php echo $defaultdata[$Login_MenuID]["gallery"]["W"];?> X <?php echo $defaultdata[$Login_MenuID]["gallery"]["H"];?> pixel.</div>
