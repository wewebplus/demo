...
$arrf = array();
$arrf[] = "a."._TABLE_FAQ_."_ID AS ID";
$arrf[] = "a."._TABLE_FAQ_."_Key AS ModKey";
$arrf[] = "a."._TABLE_FAQ_."_GID AS GID";
$arrf[] = "a."._TABLE_FAQ_."_DesDate AS DesDate";
$arrf[] = "a."._TABLE_FAQ_."_Status AS status";
$arrf[] = "a."._TABLE_FAQ_."_Ignore AS allignore";
$arrf[] = "a."._TABLE_FAQ_."_Start AS StartDate";
$arrf[] = "a."._TABLE_FAQ_."_End AS ExpireDate";
$arrf[] = "a."._TABLE_FAQ_.'_PictureHome AS PictureHome';
$arrf[] = "a."._TABLE_FAQ_."_Picture AS Picture";
$arrf[] = "a."._TABLE_FAQ_."_PictureAlt AS PictureAlt";
$arrf[] = "a."._TABLE_FAQ_."_StatusHome AS StatusHome";
$arrf[] = "a."._TABLE_FAQ_."_Status AS ListStatus";
$arrf[] = "a."._TABLE_FAQ_."_StatusRating AS ListRating";
$arrf[] = "a."._TABLE_FAQ_."_StatusComment AS ListComment";
$arrf[] = "a."._TABLE_FAQ_."_StatusRelate AS ListRelate";
$arrf[] = "a."._TABLE_FAQ_."_Pin AS ListPin";
$arrf[] = "a."._TABLE_FAQ_."_StatusContentPassword AS ListStatusContentPassword";
$arrf[] = "a."._TABLE_FAQ_."_ContentPassword AS ContentPassword";
$arrf[] = "a."._TABLE_FAQ_."_Public AS ContentPublic";
foreach($systemLang as $lkey=>$lval){
	$arrf[] = $lkey."."._TABLE_FAQ_DETAIL_."_ID AS SubjectID".$lkey;
	$arrf[] = $lkey."."._TABLE_FAQ_DETAIL_."_Subject AS Subject".$lkey;
	$arrf[] = $lkey."."._TABLE_FAQ_DETAIL_."_Title AS Title".$lkey;
	$arrf[] = $lkey."."._TABLE_FAQ_DETAIL_."_HTMLFileName AS HTMLFileName01".$lkey;
	$arrf[] = $lkey."."._TABLE_FAQ_DETAIL_."_Status AS Status".$lkey;
	$arrf[] = $lkey."."._TABLE_FAQ_DETAIL_."_By AS By".$lkey;
}
$sql = "SELECT ".implode(',',$arrf)." FROM "._TABLE_FAQ_." a";
foreach($systemLang as $lkey=>$lval){
	$sql .= " LEFT JOIN "._TABLE_FAQ_DETAIL_." ".$lkey." ON (a."._TABLE_FAQ_."_ID = ".$lkey."."._TABLE_FAQ_DETAIL_."_ContentID AND ".$lkey."."._TABLE_FAQ_DETAIL_."_Lang = '".$lkey."')";
}
$sql .= " WHERE "._TABLE_FAQ_."_ID = ".(int)$itemid;
unset($arrf);
$z = new __webctrl;
$z->sql($sql);
$v = $z->row();
