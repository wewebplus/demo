...
function getSubCategoriesEcho($parent_id, $level) {
    ...
    $sql .= " (";
        ...
        $arrf[] = "a."._TABLE_FRONTMENU_.'_ParentID AS ParentID';
        ...
        $sql .= " AND ";
        $sql .= "(a."._TABLE_FRONTMENU_."_ParentID  = ".$parent_id.")";
        unset($arrf);
    $sql .= ") TB";
    $sql .= " WHERE 1";
    $z->sql($sql);
...
function getSubCategories($parent_id, $level,$instatus = null) {
    ...
    $sql .= " (";
        ...
        $arrf[] = "a."._TABLE_FRONTMENU_.'_Order AS ListOrder';
        $arrf[] = "a."._TABLE_FRONTMENU_.'_Name AS Name';
        $arrf[] = "a."._TABLE_FRONTMENU_.'_Path AS URL';
        $arrf[] = "a."._TABLE_FRONTMENU_.'_Target AS URLTarget';
        $arrf[] = "(SELECT COUNT(*) FROM "._TABLE_FRONTMENU_." WHERE "._TABLE_FRONTMENU_."_ParentID = a."._TABLE_FRONTMENU_."_ID) AS CountParent";
        $sql .= "SELECT  ".implode(',',$arrf)." FROM "._TABLE_FRONTMENU_." a";
        $sql .= " WHERE a."._TABLE_FRONTMENU_."_Folder='".$FolderKey."'";
        if(!empty($instatus)){
            $sql .= " AND a."._TABLE_FRONTMENU_."_Status='".$instatus."'";
        }
        $sql .= " AND ";
        $sql .= "(a."._TABLE_FRONTMENU_."_ParentID  = ".$parent_id.")";
        unset($arrf);
