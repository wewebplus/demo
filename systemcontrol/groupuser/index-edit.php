...
$Title = decodetxterea($Row[_TABLE_ADMIN_USERGROUP_."_Title"]);
...
<div class="mw1000 center-block">
  ...
  <div class="content-header">
    ...
    <p class="lead">Manage permission in group</p>
  </div>
        ...
        <form name="myFrm" id="myFrm" class="form-horizontal" action="?" method="post" id="form-ui">
  					...
  					<div class="col-md-3">
  							<div class="section">
  									<label for="inputShotGName" class="field prepend-icon">
  											<input type="text" name="inputShotGName" id="inputShotGName" class="gui-input" value="<?php echo $ShotName?>" maxlength="50" required data-msg-required="<?php echo $Array_Lang["txt:Please Input"][$_SESSION['Session_Admin_Language']]." ".$Array_Mod_Lang["txt:Group Shot Name"][$_SESSION['Session_Admin_Language']]?>" placeholder="<?php echo $Array_Mod_Lang["txt:Group Shot Name"][$_SESSION['Session_Admin_Language']]?>" onkeypress="checktpyingeng(event)" onblur="chkdatashotname(this)">
  											<label class="field-icon"><i class="fa fa-users"></i></label>
  									</label>
  							</div>
  					</div>
          ...
          <div class="form-group">
                  ...
                  <label for="Detail" class="field prepend-icon">
                    <textarea class="form-control" name="Detail" id="Detail" rows="3" placeholder="<?php echo $Array_Mod_Lang["txt:Group Management Detail"][$_SESSION['Session_Admin_Language']]?>"><?php echo $Title?></textarea>
                      ...
                      <tr>
                          ...
                          <td class="colgroupmenuchk">
                            <div class="checkbox-custom checkbox-primary mb5">
                              <input class="checkradios" name="groupchk_<?php echo $gkey?>"  id="groupchk_<?php echo $gkey?>" type="checkbox" <?php echo @($arrApp[$gkey]=="Yes"?'checked="checked"':'')?> value="Yes" />
                          ...
                          <tr class="trrowpma trrowpma0<?php echo $tmp?>">
                              ...
                              <td class="colselect">
                                <div class="radio-custom radio-primary mb5">
                                  <input name="<?php echo $menuIndex[$key]?>" id="R<?php echo $menuIndex[$key]?>" type="radio" <?php echo @($arrPMA[$key]=='R'?'checked="checked"':'')?> value="R" />
                                  <label for="R<?php echo $menuIndex[$key]?>">Read</label>
                                </div>
                              </td>
                              <td class="colselect">
                                <div class="radio-custom radio-primary mb5">
                                  <input name="<?php echo $menuIndex[$key]?>"  id="RW<?php echo $menuIndex[$key]?>" type="radio" class="checkradios" <?php echo @($arrPMA[$key]=='RW'?'checked="checked"':'')?> value="RW" />
                                  <label for="RW<?php echo $menuIndex[$key]?>">Read/Write</label>
                                </div>
                              </td>
                              <td class="colselect">
                                <div class="radio-custom radio-primary mb5">
                                  <input name="<?php echo $menuIndex[$key]?>" id="NA<?php echo $menuIndex[$key]?>" type="radio" class="checkradios" <?php echo @($arrPMA[$key]=='NA'?'checked="checked"':'')?> value="NA" />
