  ...
  html +='<thead>';
    html +='<tr>';
			html +='<th class="w40 text-center">';
				...
				html +='</label>';
			html += '</th>';
      html +='<th class="w250">'+Array_Mod_Lang["txt:Group Management Name"][actionlang]+'</th>';
      html +='<th class="">'+Array_Mod_Lang["txt:Group Management Detail"][actionlang]+'</th>';
      html +='<th class="w175 text-left">'+Array_Mod_Lang["txt:Group Management Status"][actionlang]+'</th>';
			html +='<th class="w175 text-center">'+Array_Mod_Lang["txt:Group Management Action"][actionlang]+'</th>';
    html +='</tr>';
  html +='</thead>';
  html +='<tbody>';
	if(len>0){
		for (var i = 0; i< len; i++) {
			...
			html +='<tr>';
			  ...
			  html +='</td>';
			  html +='<td class="">'+json['result'][i].valueTitle+'</td>';
	            ...
	            action: function () {
								var json = (function () {
									...
									$.ajax({
										...
										'url': FullPath+'groupuser/index-dataaction.php',
										'dataType': "json",
										'success': function (data) {
											json = data;
										},
...
function changeStatus(t){
	...
	$.ajax({
		...
		'type':'POST',
		'data': {MyData:mydata},
		'url': PathURL+"groupuser/index-dataaccess.php",
		'success': function (data) {
...
function chkdatashotname(t){
	...
	var json = (function () {
		...
		$.ajax({
			...
			'url': PathURL+"groupuser/index-dataaction.php",
			'dataType': "json",
			'success': function (data) {
				json = data;
			},
