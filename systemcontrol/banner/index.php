  ...
  <div id="main">
    ...
    <section id="content_wrapper">
      ...
      <section id="content" class="table-layout animated">
        ...
        <?php }else if($actiontype=="reportbanner"){?>
          <?php include("index-reportbanner.php");?>
        <?php }else{?>
        <!-- recent orders table -->
        <div class="panel">
            ...
            <div class="section">
              <form class="form-search" onsubmit="return submitFrmSearch(this);">
                <?php if($btnaspma){?>
                  ...
                  <div class="col-sm-1">
                    <button rel="1" type="button" class="btn btn-primary btn-block" onclick="clicktorequestactiononly('reportbanner',this)"><?php echo $Array_Lang["bt:Report"][$_SESSION['Session_Admin_Language']]?></button>
                  </div>
...
<script src="../vendor/plugins/bala.DualSelectList/js/bala.DualSelectList.jquery.js"></script>
