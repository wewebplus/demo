      ...
      <div class="panel-body bg-light">
        ...
        <div class="section-divider mb40" id="spy2">
              ...
              ?>
                ...
                <div id="<?php echo 'tab'.$lkey?>" class="tab-pane <?php echo $tabactive?>">
                          ...
                          ?>
										...
										<div class="form-group">
											<label for="inputStandard" class="col-lg-2 control-label"><?php echo $Array_Mod_Lang["txtinput:inputBannerCode"][$_SESSION['Session_Admin_Language']]?></label>
											<div class="col-lg-10">
												<div class="bs-component">
                          <?php
													echo '<textarea name="inputBannerCode'.$lkey.'" class="form-control" id="inputBannerCode'.$lkey.'" placeholder="'.$Array_Mod_Lang["txtinput:inputBannerCode"][$_SESSION['Session_Admin_Language']].'" rows="3">'.decodetxterea($Row['BannerCode'.$lkey]).'</textarea>';
                          ?>
												</div>
											</div>
										</div>
				...
				<div class="section-divider mb40 hidden" id="spy2">
            ...
            <label class="switch switch-primary block mt15">
							<input type="checkbox" name="StatusPublic" id="StatusPublic" value="No" <?php echo ($ContentPublic=='No'?'checked="checked"':'')?> onclick="ClickPublic(this)">
