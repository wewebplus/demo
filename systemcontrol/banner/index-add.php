                ...
                <div id="<?php echo 'tab'.$lkey?>" class="tab-pane <?php echo $tabactive?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <div class="bs-component">
                        <?php
                        echo '<textarea name="inputBannerCode'.$lkey.'" class="form-control" id="inputBannerCode'.$lkey.'" placeholder="'.$Array_Mod_Lang["txtinput:inputBannerCode"][$_SESSION['Session_Admin_Language']].'" rows="3"></textarea>';
                        ?>
                      </div>
                    </div>
                  </div>
