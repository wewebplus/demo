    ...
    <div class="panel heading-border panel-primary">
      <div class="panel-body bg-light">
        ...
        <input type="hidden" name="saveData" value="<?php echo $saveData?>" />
          ...
          <div class="col-md-6">
						<div class="bs-component">
							<p class="form-control-static text-muted"><?php echo $defaultdata[$Login_MenuID]["Position"][$ListPosition]?></p>
						</div>
          </div>
        </div>
				...
				<div class="row">
				    ...
				    <ul class="nav nav-tabs nav-justified nav-inline">
				      <?php
				      foreach($systemLang as $lkey=>$lval){
				        $tabactive = ($lkey=='Thai'?'active':'');
				        echo '<li class="'.$tabactive.'">';
				          echo '<a href="#tab'.$lkey.'" data-toggle="tab" aria-expanded="true">'.$Array_Mod_Lang["txt:Tab 01"][$lkey].'</a>';
				        echo '</li>';
				      }
				      ?>
				    </ul>
					...
					<div class="paneltabbody">
						<div class="tab-content tab-validate pn br-n">
							...
							<?php $tabactive = ($lkey=='Thai'?'active':'');?>
							<?php $DocumentType = $Row['DocumentType'.$lkey];?>
