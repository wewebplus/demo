...
$sql = "SELECT MAX("._TABLE_WEBLINK_."_Order) AS MaxO FROM "._TABLE_WEBLINK_." WHERE 1 ";
$z = new __webctrl;
$z->sql($sql);
$v = $z->row();
$Row = $v[0];
...
$insert = array();
$insert[_TABLE_WEBLINK_.'_Key'] = "'".$mymenukey."'";
$insert[_TABLE_WEBLINK_.'_GroupID'] = sql_safe($GroupID,false,true);
$insert[_TABLE_WEBLINK_.'_GroupBanner'] = "'".sql_safe($selectGroup)."'";
$insert[_TABLE_WEBLINK_.'_GroupW'] = "'".sql_safe($W)."'";
$insert[_TABLE_WEBLINK_.'_GroupH'] = "'".sql_safe($H)."'";
$insert[_TABLE_WEBLINK_.'_CreateDate'] = "NOW()";
$insert[_TABLE_WEBLINK_.'_LastUpdate'] = "NOW()";
$insert[_TABLE_WEBLINK_.'_CreateByID'] = sql_safe($_SESSION['Session_Admin_ID'],false,true);
$insert[_TABLE_WEBLINK_.'_UpdateByID'] = sql_safe($_SESSION['Session_Admin_ID'],false,true);
$insert[_TABLE_WEBLINK_.'_Start'] = "'".sql_safe($inputStartDate)."'";
$insert[_TABLE_WEBLINK_.'_End'] = "'".sql_safe($inputExpireDate)."'";
$insert[_TABLE_WEBLINK_.'_Status'] = "'On'";
$insert[_TABLE_WEBLINK_.'_Ignore'] = "'".sql_safe($Lang)."'";
$insert[_TABLE_WEBLINK_.'_Order'] = sql_safe($MaxOrder,false,true);

$z = new __webctrl;
$z->insert(_TABLE_WEBLINK_,$insert);
$insertid = $z->insertid();
unset($insert);
...
foreach($systemLang as $lkey=>$lval){
  ...
  $insert[_TABLE_WEBLINK_DETAIL_.'_ContentID'] = "'".sql_safe($insertid)."'";
...
$sql = "UPDATE "._TABLE_WEBLINK_." SET "._TABLE_WEBLINK_."_Ignore='".sql_safe($Lang)."' WHERE "._TABLE_WEBLINK_."_ID = ".(int)$insertid;
$z = new __webctrl;
$z->query($sql);
