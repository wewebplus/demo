function loadpageajax(page){
  ...
  html +='<thead>';
    html +='<tr>';
		...
		html +='<th class="w250">'+Array_Mod_Lang["txt:Group"][actionlang]+'</th>';
		html +='<th class="">'+Array_Mod_Lang["txt:Subject"][actionlang]+'</th>';
		html +='<th class="w200">'+Array_Mod_Lang["txt:Date"][actionlang]+'</th>';
...
function savelistorderContent(myval,pagesize){
  ...
  var FullPath = $('#ajaxFrm input[name=PathURL]').val();
    ...
    type:"POST",
    url:FullPath+'weblink/index-dataaction.php',
...
function changeStatus(t){
	...
	$.ajax({
		...
		'type':'POST',
		'data': {MyData:mydata},
		'url': PathURL+"weblink/index-dataaccess.php",
		'success': function (data) {
