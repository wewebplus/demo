<?php
//$mybasepath = $_SERVER['DOCUMENT_ROOT']."/osotspa-new/upload/userfiles/";
$mybaseurl = "http://".$_SERVER["SERVER_NAME"]."/acicertified/upload/userfiles/";
$mybasepath = $_SERVER['DOCUMENT_ROOT']."/acicertified/upload/userfiles/";
/*
