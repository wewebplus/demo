...
//$basePath = $_SERVER['DOCUMENT_ROOT']."/yellowtire/upload/userfiles/";
$basePath = $config["current_path"];
...
// ALWAYS put the final slash (/)
//$baseUrl = "http://".$_SERVER["SERVER_NAME"]."/yellowtire/upload/userfiles/";;
$baseUrl = $config["base_url"].$config["upload_dir"];
