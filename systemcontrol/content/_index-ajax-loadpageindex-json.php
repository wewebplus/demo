...
$lkey = $_SESSION['Session_Admin_Language'];
$sql = "";
$ArrField = array();
$ArrField[] = "TBmain.ID";
...
$sql .= "("	;
  ...
  $arrf[] = "a."._TABLE_CONTENT_."_Public AS ListPublic";
    ...
    $sql .= " LEFT JOIN (";
      ...
      $sql .= " WHERE "._TABLE_CONTENT_DETAIL_."_Lang = '".$lkey."'";
      unset($arrjoinlang);
    $sql .= ") ".$lkey." ON (a."._TABLE_CONTENT_."_ID = ".$lkey."."._TABLE_CONTENT_DETAIL_."_ContentID)";
	}
...
if($RecordCount>0) {
    ...
    $Picture = $PathUploadPicture."b-".$Row["Picture"];
		if(is_file($Picture)){
