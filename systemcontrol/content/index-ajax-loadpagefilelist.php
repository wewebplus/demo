...
$ArrField[] = _TABLE_CONTENT_FILE_."_ContentID AS ContentID";
$ArrField[] = _TABLE_CONTENT_FILE_."_Session AS Session";
$ArrField[] = _TABLE_CONTENT_FILE_."_Subject AS Subject";
...
$sql = "SELECT ".implode(",",$ArrField)." FROM "._TABLE_CONTENT_FILE_." WHERE 1 ";
$sql .=" AND "._TABLE_CONTENT_FILE_."_ContentID = ".(int)$ContentID;
$sql .=" AND "._TABLE_CONTENT_FILE_."_Flag = '".$myflag."'";
if($SessionID<>""){
  $sql .= " AND "._TABLE_CONTENT_FILE_."_Session='".$SessionID."'";
}
$sql .="  ORDER BY "._TABLE_CONTENT_FILE_."_Order ASC";
unset($ArrField);
$z = new __webctrl;
$z->sql($sql);
$RecordCount = $z->num();
