      ...
      <div class="panel-body bg-light">
					...
					<div class="col-md-3">
							<div class="section">
									<label for="datepickerDesDate" class="field prepend-icon">
											<input type="text" id="datepickerDesDate" name="datepickerDesDate" readonly="readonly" class="gui-input" value="<?php echo $DesDate?>" placeholder="Datepicker From">
											<label class="field-icon"><i class="fa fa-calendar-o"></i></label>
									</label>
							</div>
					</div>
        ...
        <div class="section-divider mb40" id="spy2">
						...
						<div class="tab-content tab-validate pn br-n">
					        ...
					        <!-- Text Areas -->
					            ...
					            <div class="col-md-12">
					                <div class="section">
					                    <label class="field prepend-icon">
					                        <input type="text" name="<?php echo "inputBy".$lkey?>" class="gui-input" value="<?php echo $Row['By'.$lkey]; ?>" data-msg-required="<?php echo $Array_Mod_Lang["txtinput:inputBy"][$_SESSION['Session_Admin_Language']]?> <?php echo ($countlang>1?"( ".$lval." Language )":"");?>" placeholder="<?php echo $Array_Mod_Lang["txtinput:inputBy"][$_SESSION['Session_Admin_Language']]?> <?php echo ($countlang>1?"( ".$lval." Language )":"");?>">
					                        <label for="firstname" class="field-icon"><i class="fa fa-bullhorn"></i></label>
					                    </label>
					                </div>
					            </div>
            ...
            <label class="switch switch-primary block mt15">
							<input type="checkbox" name="ListRating" id="ListRating" value="Yes" <?php echo ($ListRating=='Yes'?'checked="checked"':'')?>>
