...
$ArrField[] = _TABLE_CONTENT_PIC_."_ID AS ID";
$ArrField[] = _TABLE_CONTENT_PIC_."_ContentID AS CID";
$ArrField[] = _TABLE_CONTENT_PIC_."_FileName AS FileName";
$ArrField[] = _TABLE_CONTENT_PIC_."_Detail AS Detail";
$ArrField[] = _TABLE_CONTENT_PIC_."_AddIndex AS AddIndex";

$sql = "SELECT ".implode(",",$ArrField)." FROM "._TABLE_CONTENT_PIC_." WHERE 1 ";
$sql .=" AND "._TABLE_CONTENT_PIC_."_ContentID = ".(int)$itemid;
$sql .="  ORDER BY "._TABLE_CONTENT_PIC_."_Order ASC";
unset($ArrField);
$z = new __webctrl;
$z->sql($sql);
$RecordCount = $z->num();
