...
$sql .= "("	;
  ...
  $ArrField[] = "TBList.ListCountView";
  $ArrField[] = "TBList.ListCountComment";
  $ArrField[] = "TBList.StartDate";
  $ArrField[] = "TBList.EndDate";
  $ArrField[] = "TBList.StatusHome";
  $ArrField[] = "TBList.ListRating";
  $ArrField[] = "TBList.ListComment";
  $ArrField[] = "TBList.ListPin";
  ...
  $sql .= "("	;
    ...
    $arrf[] = $langkey."."._TABLE_CONTENT_DETAIL_."_Title AS Title".$langkey;
    ...
    $arrf[] = "LangDefault."._TABLE_CONTENT_DETAIL_."_Title AS TitleDefault";
    ...
    $sql .= " INNER JOIN (";
      ...
      $arrjoinlang[] = _TABLE_CONTENT_DETAIL_."_Title";
  ...
  $sql .= ") TBList";
  $sql .= " LEFT JOIN (";
    $sql .= "SELECT "._TABLE_CONTENT_GROUP_."_ID AS ID,"._TABLE_CONTENT_GROUP_."_".$langkey." AS GroupName FROM "._TABLE_CONTENT_GROUP_;
    $sql .= " WHERE "._TABLE_CONTENT_GROUP_."_Folder IN ('".implode("','",$dataModuleKey)."')";
...
if($RecordCount>0) {
    ...
    $arr["valueTitle"] = echoDetailTooneline($FullTitle);
