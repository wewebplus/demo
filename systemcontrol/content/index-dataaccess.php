...
switch($actiontype){
	case 'changethisstatus':
		...
		$sql = "SELECT "._TABLE_CONTENT_."_Key AS myKey,"._TABLE_CONTENT_."_ID AS ID,"._TABLE_CONTENT_."_Status AS ListStatus FROM "._TABLE_CONTENT_." WHERE "._TABLE_CONTENT_."_ID = ".(int)$itemid;
		$z = new __webctrl;
		$z->sql($sql);
		$v = $z->row();
		$Row = $v[0];
	...
	break;case 'changeusestatushome':
		$itemid = $itemid;
		$StatusTo = $statusto;
		// $sql = "SELECT "._TABLE_CONTENT_."_ID AS ID,"._TABLE_CONTENT_."_StatusHome AS ListStatus FROM "._TABLE_CONTENT_." WHERE "._TABLE_CONTENT_."_ID = ".(int)$itemid;
		// $z = new __webctrl;
		// $z->sql($sql);
		// $v = $z->row();
		// $Row = $v[0];
		$update = array();
		$update[_TABLE_CONTENT_."_StatusHome"] = "'".$StatusTo."'";
		$update[_TABLE_CONTENT_."_LastUpdate"] = "NOW()";
		$update[_TABLE_CONTENT_."_UpdateByID"] = sql_safe($_SESSION['Session_Admin_ID'],false,true);
		$z = new __webctrl;
		$z->update(_TABLE_CONTENT_,$update,array(_TABLE_CONTENT_."_ID=" => $itemid));
  ...
  break;case 'changeuseRating':
    ...
    // echo $StatusType;
    $update = array();
		$update[_TABLE_CONTENT_."_StatusRating"] = "'".$StatusTo."'";
		$update[_TABLE_CONTENT_."_LastUpdate"] = "NOW()";
		$update[_TABLE_CONTENT_."_UpdateByID"] = sql_safe($_SESSION['Session_Admin_ID'],false,true);
		$z = new __webctrl;
		$z->update(_TABLE_CONTENT_,$update,array(_TABLE_CONTENT_."_ID=" => $itemid));
  ...
  break;case 'changeusebtnComment':
    ...
    // echo $StatusType;
    $update = array();
		$update[_TABLE_CONTENT_."_StatusComment"] = "'".$StatusTo."'";
		$update[_TABLE_CONTENT_."_LastUpdate"] = "NOW()";
		$update[_TABLE_CONTENT_."_UpdateByID"] = sql_safe($_SESSION['Session_Admin_ID'],false,true);
		$z = new __webctrl;
		$z->update(_TABLE_CONTENT_,$update,array(_TABLE_CONTENT_."_ID=" => $itemid));
  ...
  break;case 'changeusebtnPin':
    ...
    // echo $StatusType;
    $update = array();
		$update[_TABLE_CONTENT_."_Pin"] = "'".$StatusTo."'";
		$update[_TABLE_CONTENT_."_LastUpdate"] = "NOW()";
		$update[_TABLE_CONTENT_."_UpdateByID"] = sql_safe($_SESSION['Session_Admin_ID'],false,true);
		$z = new __webctrl;
		$z->update(_TABLE_CONTENT_,$update,array(_TABLE_CONTENT_."_ID=" => $itemid));
  ...
  break;case 'changeusebtnPublic':
    ...
    // echo $StatusType;
    $update = array();
		$update[_TABLE_CONTENT_."_Public"] = "'".$StatusTo."'";
		$update[_TABLE_CONTENT_."_LastUpdate"] = "NOW()";
		$update[_TABLE_CONTENT_."_UpdateByID"] = sql_safe($_SESSION['Session_Admin_ID'],false,true);
		$z = new __webctrl;
		$z->update(_TABLE_CONTENT_,$update,array(_TABLE_CONTENT_."_ID=" => $itemid));
	...
	break;case 'sort':
		...
		if($counArr>0){
			for($i=1;$i<$counArr;$i++){
				...
				if($value <> 'null'){
					$j = $counArr-$i;
					$update[_TABLE_CONTENT_."_Order"] = sql_safe($j,false,true);
					$z = new __webctrl;
					$z->update(_TABLE_CONTENT_,$update,array(_TABLE_CONTENT_."_ID=" => (int)$value));
					unset($update);
				}
			}
		}
