        ...
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <div class="bs-component frmalert">
              <input type="text" name="<?php echo "inputGroupSubject"?>" class="form-control reqs" placeholder="<?php echo $Array_Mod_Lang["txtinput:inputGroupSubject"][$_SESSION['Session_Admin_Language']]?>">
            </div>
          </div>
        </div>
        <div class="form-group">
          <label for="inputStandard" class="col-lg-3 control-label"><?php echo $Array_Mod_Lang["txtinput:inputGroupFolder"][$_SESSION['Session_Admin_Language']]?></label>
          <div class="col-lg-8">
            <div class="bs-component frmalert">
              <input type="text" name="<?php echo "inputGroupFolder"?>" class="form-control reqs" placeholder="<?php echo $Array_Mod_Lang["txtinput:inputGroupFolder"][$_SESSION['Session_Admin_Language']]?>">
            </div>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <div class="bs-component frmalert">
              <textarea class="form-control" name="<?php echo "inputGroupTitle"?>" rows="4" placeholder="<?php echo $Array_Mod_Lang["txtinput:inputGroupTitle"][$_SESSION['Session_Admin_Language']]?>"></textarea>
            </div>
          </div>
        </div>
