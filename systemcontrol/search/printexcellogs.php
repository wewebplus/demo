...
$objPHPExcel->getActiveSheet()->getStyle('A1:E1')->getFill()->getStartColor()->setARGB('FFb7dee8');
$objPHPExcel->getActiveSheet()->getStyle('A1:E1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$objPHPExcel->getActiveSheet()->getStyle('A2:E2')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);
$objPHPExcel->getActiveSheet()->getStyle('A2:E2')->getFill()->getStartColor()->setARGB('FFb7dee8');
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B2', 'IP');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C2', 'Browser');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D2', 'Platform');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E2', 'userAgent');
...
if($RecordCount>0) {
    ...
    $userAgent = $Row["userAgent"];
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('B'.$startindexrow, $ListIP, PHPExcel_Cell_DataType::TYPE_STRING);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('C'.$startindexrow, $Browser, PHPExcel_Cell_DataType::TYPE_STRING);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('D'.$startindexrow, $Platform, PHPExcel_Cell_DataType::TYPE_STRING);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('E'.$startindexrow, $userAgent, PHPExcel_Cell_DataType::TYPE_STRING);
		$index++;
	}
}
