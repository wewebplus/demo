     ...
     <section id="content" class="table-layout animated">
       ...
       <div class="tray tray-center">
        ...
        <?php if($actiontype=="add"){?>
          <?php include("task-add.php");?>
        <?php }else if($actiontype=="view"){?>
          <?php include("task-view.php");?>
        <?php }else if($actiontype=="send"){?>
          <?php include("task-send.php");?>
        <?php }else{?>
          <!-- create new panel -->
          <!-- recent orders table -->
          <div class="panel">
...
<script type="text/javascript" src="<?php echo "task.js?ver=".rand()?>"></script>
<script type="text/javascript" src="<?php echo (empty($actiontype)?'task-list.js?ver='.rand():'task-'.$actiontype.'.js?ver='.rand());?>"></script>
</body>
</html>
