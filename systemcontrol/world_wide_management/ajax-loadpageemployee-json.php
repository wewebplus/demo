...
$sql = "SELECT "._TABLE_ADMIN_USERGROUP_."_ID AS ID, "._TABLE_ADMIN_USERGROUP_."_Name AS Name, "._TABLE_ADMIN_USERGROUP_."_Title AS Title, "._TABLE_ADMIN_USERGROUP_."_Status AS ListStatus";
$sql .= " FROM "._TABLE_ADMIN_USERGROUP_." WHERE 1";
