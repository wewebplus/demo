jQuery(document).ready(function() {
  ...
  $("#myFrm").validate({
		...
		submitHandler: function(form) {
			...
			$.ajax({
				...
				'type':'POST',
				'data':$(form).serialize(),
				'url': PathURL+"intropage/index-ajax-addnew.php",
  ...
  $( "#ListBtn" ).live( "click", function() {
	...
	$('.checkradioI').each(function() {
		var cld = $(this).closest('div.boxlang');
		if($(this).is(':checked')) {
			var myval = $(this).val();
			if(myval=='E'){
				cld.find('.pictureintro').hide();
				cld.find('.embedintro').show();
				cld.find('.linkintro').hide();
				cld.find('.htmlintro').hide();
			}else if(myval=='L'){
				cld.find('.pictureintro').hide();
				cld.find('.embedintro').hide();
				cld.find('.linkintro').show();
				cld.find('.htmlintro').hide();
			}else if(myval=='H'){
				cld.find('.pictureintro').hide();
				cld.find('.embedintro').hide();
				cld.find('.linkintro').hide();
				cld.find('.htmlintro').show();
			}else{
				cld.find('.pictureintro').show();
				cld.find('.embedintro').hide();
				cld.find('.linkintro').hide();
				cld.find('.htmlintro').hide();
			}
