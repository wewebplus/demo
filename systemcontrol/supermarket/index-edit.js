        ...
        if (data.method === 'getCroppedCanvas') {
          ...
          $.ajax({
              ...
              success: function(output) {
								// console.log(output.pathfile);
                $('#putDataFile').val($.trim(output.phyfilename));
                var htmlimgpw = '<img src="'+$.trim(output.pathfile)+'" alt="" />';
      ...
      for(var instanceName in CKEDITOR.instances){
          CKEDITOR.instances[instanceName].updateElement();
			...
			$.ajax({
				...
				'type':'POST',
				'data':$(form).serialize(),
				'url': PathURL+"supermarket/index-ajax-update.php",
