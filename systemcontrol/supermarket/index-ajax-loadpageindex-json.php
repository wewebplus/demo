...
// _TABLE_SUPERMARKET_GROUP_
// _TABLE_SUPERMARKET_WTIME_
// _TABLE_ADMIN_WDAY_
...
$ArrField[] = "IF(TBGroup.InGroup IS NULL or TBGroup.InGroup = '', '-', TBGroup.InGroup) as InGroup";
$ArrField[] = "IF(TBGroup.InGroupID IS NULL or TBGroup.InGroupID = '', '', TBGroup.InGroupID) as InGroupID";
...
$sql .= "("	;
	...
	$arrf[] = "a."._TABLE_SUPERMARKET_."_Order AS ListOrder";
	$arrf[] = "a."._TABLE_SUPERMARKET_."_Start AS StartDate";
	$arrf[] = "a."._TABLE_SUPERMARKET_."_End AS EndDate";
  ...
  $arrf[] = "a."._TABLE_SUPERMARKET_."_Public AS ListPublic";
  $arrf[] = "a."._TABLE_SUPERMARKET_."_View AS ListCountView";
  $arrf[] = "a."._TABLE_SUPERMARKET_."_Comment AS ListCountComment";
  $arrf[] = "a."._TABLE_SUPERMARKET_."_CountryName AS CountryName";
  $arrf[] = $langkey."."._TABLE_SUPERMARKET_DETAIL_."_ID AS SubjectID".$langkey;
	$arrf[] = $langkey."."._TABLE_SUPERMARKET_DETAIL_."_Subject AS Subject".$langkey;
	$arrf[] = $langkey."."._TABLE_SUPERMARKET_DETAIL_."_Status AS Status".$langkey;
	$sql .= "SELECT  ".implode(',',$arrf)." FROM "._TABLE_SUPERMARKET_." a";
  $sql .= " INNER JOIN (";
    $arrjoinlang = array();
    $arrjoinlang[] = _TABLE_SUPERMARKET_DETAIL_."_ID";
    $arrjoinlang[] = _TABLE_SUPERMARKET_DETAIL_."_ContentID";
    $arrjoinlang[] = _TABLE_SUPERMARKET_DETAIL_."_Subject";
    $arrjoinlang[] = _TABLE_SUPERMARKET_DETAIL_."_Status";
    $sql .= "SELECT ".implode(',',$arrjoinlang)." FROM "._TABLE_SUPERMARKET_DETAIL_;
    $sql .= " WHERE "._TABLE_SUPERMARKET_DETAIL_."_Lang = '".$langkey."'";
    unset($arrjoinlang);
  $sql .= ") ".$langkey." ON (a."._TABLE_SUPERMARKET_."_ID = ".$langkey."."._TABLE_SUPERMARKET_DETAIL_."_ContentID)";
  $sql .= " WHERE a."._TABLE_SUPERMARKET_."_Key IN ('".implode("','",$dataModuleKey)."')";
	unset($arrf);
$sql .= ") TBmain";
$sql .= " LEFT JOIN (";
  $arrjoingroup = array();
  $arrjoingroup[] = _TABLE_SUPERMARKET_GROUP_."_ContentID AS ContentID";
  $arrjoingroup[] = "GROUP_CONCAT("._TABLE_SUPERMARKET_GROUP_."_GroupName) AS InGroup";
  $arrjoingroup[] = "GROUP_CONCAT("._TABLE_SUPERMARKET_GROUP_."_GroupID) AS InGroupID";
  $sql .= "SELECT ".implode(',',$arrjoingroup)." FROM "._TABLE_SUPERMARKET_GROUP_." WHERE 1 GROUP BY "._TABLE_SUPERMARKET_GROUP_."_ContentID";
  unset($arrjoingroup);
$sql .= ") TBGroup ON (TBmain.ID = TBGroup.ContentID)";
$sql .= " WHERE 1";
if(!empty($dataGroup)){
  $sql .= " AND FIND_IN_SET(".$dataGroup.",TBGroup.InGroupID)>0";
}
...
if($RecordCount>0) {
    ...
    $FullGroupname = $Row["InGroup"];

    $sql = "SELECT "._TABLE_SUPERMARKET_WTIME_."_Open AS _Open,"._TABLE_SUPERMARKET_WTIME_."_Close AS _Close,TBJoin.DayName FROM "._TABLE_SUPERMARKET_WTIME_;
    $sql .= " LEFT JOIN (";
