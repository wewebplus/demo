...
$sql .= "("	;
  ...
  $sql .= " WHERE "._TABLE_DOWNLOAD_GROUP_."_Folder = '".$ModuleKey."'";
  unset($ArrInnerField);
$sql .= ") TBmain";
$sql .= " LEFT JOIN (";
  $sql .= "SELECT * FROM ";
  $sql .= "(";
    ...
    $arrinnercount[] = _TABLE_DOWNLOAD_."_GID AS JoinContentID";
    $sql .= "SELECT ".implode(',',$arrinnercount)." FROM "._TABLE_DOWNLOAD_." WHERE 1 GROUP BY "._TABLE_DOWNLOAD_."_GID";
    unset($arrinnercount);
  $sql .= ") TBCount";
