...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B1', 'ID Card');
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G1', 'User');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H1', 'Email');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I1', 'Tel');
...
if($RecordCount>0) {
    ...
    $MemberLevelShow = $arrMemberType[$Row["MLevel"]];
    $AName = $Row["AName"];
    $FName = $Row["FName"];
    $LName = $Row["LName"];
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('B'.$startindexrow, $IDCard, PHPExcel_Cell_DataType::TYPE_STRING);
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F'.$startindexrow, $MemberLevelShow);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValueExplicit('G'.$startindexrow, $Username, PHPExcel_Cell_DataType::TYPE_STRING);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('H'.$startindexrow, $Email);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I'.$startindexrow, $Tel);
	}
}
// exit();
