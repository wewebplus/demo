      ...
      <section id="content" class="table-layout animated">
        ...
        <div id="modal-formmenu" class="popup-basic popup-importprd admin-form mfp-with-anim mfp-hide">
          <div class="panel">
              ...
              <input type="hidden" name="inputMenuKey" value="" />
                ...
                <div class="panel-body p25">
                  ...
                  <div class="form-group">
                    <label class="col-md-2 control-label"><?php echo $Array_Mod_Lang["txtinput:SelectMenuName"][$_SESSION['Session_Admin_Language']]?></label>
                    <div class="col-md-6 frmalert field">
                      <?php
                        ...
                        // print_r($arrListMenu);
                        // echo '</pre>';
                        echo '<select class="form-control" name="SelectMenu" onchange="myselectMenu(this)">';
                          echo '<option value=""> - เลือกเมนู - </option>';
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-10 frmalert field">
                      <?php
                      echo '<input type="text" name="inputMenuUrl" class="form-control reqs" value="#s" dataalert="กรุณากรอก URL ขื่อเมนู">';
                      ?>
                    </div>
                  </div>
                  <div class="form-group">
