      ...
      <section id="content" class="table-layout animated">
        ...
        <?php }else{?>
          ...
          <div class="panel-body">
            <div class="section">
              <?php
              $LinkToRSS = encode_URL('Login_MenuID='.$Login_MenuID.'&mylang='.$_SESSION['Session_Admin_Language']."&mytype=download&mykey=".$dataGroupMathching[$Login_MenuID]);
              ?>
...
<script type="text/javascript" src="<?php echo (empty($actiontype)?'index-list.js':'index-'.$actiontype.'.js?ver='.$myrand);?>"></script>
</body>
</html>
