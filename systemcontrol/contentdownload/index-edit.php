...
foreach($systemLang as $lkey=>$lval){
	...
	$arrf[] = $lkey."."._TABLE_DOWNLOAD_DETAIL_."_E AS E".$lkey;
...
$ContentPasswor = $Row["ContentPassword"];
								...
								<div class="col-md-12">
										<div class="section">
												<label class="field prepend-icon">
														<input type="text" name="<?php echo "inputSubject".$lkey?>" class="gui-input" value="<?php echo $Row['Subject'.$lkey]; ?>" placeholder="<?php echo $Array_Mod_Lang["txtinput:inputSubject"][$_SESSION['Session_Admin_Language']]?> <?php echo ($countlang>1?"( ".$lval." Language )":"");?>">
...
<div class="boxcroptextsize">max size <?php echo $defaultdata[$Login_MenuID]["img"]["W"];?> * <?php echo $defaultdata[$Login_MenuID]["img"]["H"];?> px.</div>
            ...
            <label class="switch switch-primary block mt5">
					...
					<div class="col-md-3 frmalert">
						<input type="text" id="ContentPassword" name="ContentPassword" class="form-control" <?php echo ($ListStatusContentPassword=='Yes'?'required':'readonly')?> value="<?php echo $ContentPasswor?>" placeholder="Type Here..."  data-msg-required="<?php echo $Array_Mod_Lang["txt:Password"][$_SESSION['Session_Admin_Language']]?>">
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-2 control-label"> </label>
