...
$ArrField[] = _TABLE_DOWNLOAD_FILE_."_ContentID AS CID";
$ArrField[] = _TABLE_DOWNLOAD_FILE_."_Session AS Session";
$ArrField[] = _TABLE_DOWNLOAD_FILE_."_Subject AS Detail";
...
$sql = "SELECT ".implode(",",$ArrField)." FROM "._TABLE_DOWNLOAD_FILE_." WHERE "._TABLE_DOWNLOAD_FILE_."_ID = ".intval($itemid);
unset($arrf);
$z = new __webctrl;
$z->sql($sql);
$v = $z->row();
