...
class __webctrl
{
    ...
    public function __construct()
    {
        ...
        try {
            ...
            $this->link = new mysqli( _DB_HOSTNAME_, _DB_USERNAME_, _DB_PASSWORD_, _DB_NAME_ );
    ...
    */
    ...
    public function num()
    {
        ...
        {
			$this->total_num = $num_rows->num_rows;
            return $num_rows->num_rows;
        }
    }
	...
	public function block_injection($str){
		$str = htmlspecialchars($str,ENT_QUOTES );//,ENT_QUOTES //ENT_NOQUOTES
