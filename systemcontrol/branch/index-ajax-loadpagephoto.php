...
$ArrField[] = _TABLE_SUPERMARKET_PHOTO_."_ID AS ID";
$ArrField[] = _TABLE_SUPERMARKET_PHOTO_."_ContentID AS CID";
$ArrField[] = _TABLE_SUPERMARKET_PHOTO_."_FileName AS FileName";
$ArrField[] = _TABLE_SUPERMARKET_PHOTO_."_Detail AS Detail";
$ArrField[] = _TABLE_SUPERMARKET_PHOTO_."_AddIndex AS AddIndex";

$sql = "SELECT ".implode(",",$ArrField)." FROM "._TABLE_SUPERMARKET_PHOTO_." WHERE 1 ";
$sql .=" AND "._TABLE_SUPERMARKET_PHOTO_."_ContentID = ".(int)$itemid;
$sql .="  ORDER BY "._TABLE_SUPERMARKET_PHOTO_."_Order ASC";
unset($ArrField);
$z = new __webctrl;
$z->sql($sql);
$RecordCount = $z->num();
