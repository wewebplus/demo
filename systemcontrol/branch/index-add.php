...
$InEstimatedPrice = "";
$Certificate_of_hygenic = "";
$_Number_of_chef_thai = "";
$_Thai_cooking_experience = "";
$_Number_of_chef_foreign = "";
$_Foreign_with_thai_experience = "";
$_Front_officer = "";
$_Front_officer_with_thai_experience = "";
$_Seat = "";
$_Space = "";
$_Branch_in_country = "";
$_Branch_in_overseas = "";
$_Percentage_of_customer_thai = "";
$_Percentage_of_customer_non_thai = "";
$_Non_thai_product = "";

$arrIngredientsUsed = array();
$arrPurchaseofraw = array();
$_Purchase_of_raw_materials_other = "";
$arrPrmarketing = array();
$_Pr_marketing_promotion_activities_other = "";
					...
					<div class="col-md-10 frmalert">
						...
						if(count($arrayUser)>0){
								...
								foreach($arrayUser as $gk=>$gv){
									echo '<option value="'.$gv["UserID"].'">'.$gv["UserName"].'</option>';
								}
								echo '</select>';
						}
						?>
            ...
            <span><?php echo $Array_Mod_Lang["txt:Head 02"][$_SESSION['Session_Admin_Language']]?></span>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<div class="bs-component">
							<?php
							echo '<input type="text" name="inputAddress_1" class="form-control" value="" required data-msg-required="'.$Array_Mod_Lang["txtinput:inputAddress"][$_SESSION['Session_Admin_Language']].'" placeholder="'.$Array_Mod_Lang["txtinput:inputAddress"][$_SESSION['Session_Admin_Language']].'">';
							?>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<div class="bs-component">
							<?php
							echo '<input type="text" name="inputAddress_2" class="form-control" value="" placeholder="'.$Array_Mod_Lang["txtinput:inputAddress"][$_SESSION['Session_Admin_Language']].'">';
							?>
						</div>
					</div>
				</div>
          ...
          <div class="col-lg-6">
            ...
            <span><?php echo $Array_Mod_Lang["txt:Head 03"][$_SESSION['Session_Admin_Language']]?></span>
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<input type="text" name="<?php echo "inputContact_person"?>" class="gui-input" value="" placeholder="<?php echo $Array_Mod_Lang["txtinput:inputContact_person"][$_SESSION['Session_Admin_Language']]?>">
					</div>
					...
					<div class="col-md-3">
						<input type="text" name="<?php echo "inputContact_position"?>" class="gui-input" value="" placeholder="<?php echo $Array_Mod_Lang["txtinput:inputContact_position"][$_SESSION['Session_Admin_Language']]?>">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-10">
						<div class="bs-component">
							<input type="text" name="<?php echo "inputCurrency"?>" class="gui-input" value="" placeholder="<?php echo $Array_Mod_Lang["txtinput:inputCurrency"][$_SESSION['Session_Admin_Language']]?>">
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<div class="bs-component">
							<input type="text" name="<?php echo "inputRegistered_no_of_juristic_person"?>" class="gui-input" value="" placeholder="<?php echo "Registered No. of Juristic Person"?>">
							<div class="showrecommend"><span><?php echo "Registered No. of Juristic Person"?></span></div>
						</div>
					</div>
					<div class="col-md-5">
						<div class="bs-component">
							<input type="text" name="<?php echo "inputMonth_year_of_establishment"?>" class="gui-input" value="" placeholder="<?php echo "Month/Year of establishment "?>">
					            ...
					            <div class="col-md-12">
					                <div class="section">
					                    <label class="field prepend-icon">
					                        <input type="text" name="<?php echo "inputSubject".$lkey?>" data-rule-required="true" class="gui-input" value="" data-msg-required="<?php echo $Array_Mod_Lang["txtinput:inputSubject"][$_SESSION['Session_Admin_Language']]?> <?php echo ($countlang>1?"( ".$lval." Language )":"");?>" placeholder="<?php echo $Array_Mod_Lang["txtinput:inputSubject"][$_SESSION['Session_Admin_Language']]?> <?php echo ($countlang>1?"( ".$lval." Language )":"");?>">
