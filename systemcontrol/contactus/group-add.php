                ...
                <div id="<?php echo 'tab'.$lkey?>" class="tab-pane <?php echo $tabactive?>">
                  <div class="boxlang">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-8">
                        <div class="bs-component">
                          <input type="email" name="<?php echo "inputGroupEmail".$lkey?>" class="form-control" required data-msg-required="<?php echo $Array_Mod_Lang["txtinput:inputGroupEmail"][$_SESSION['Session_Admin_Language']]?> <?php echo ($countlang>1?"( ".$lval." Language )":"");?>" placeholder="<?php echo $Array_Mod_Lang["txtinput:inputGroupEmail"][$_SESSION['Session_Admin_Language']]?> <?php echo ($countlang>1?"( ".$lval." Language )":"");?>">
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
