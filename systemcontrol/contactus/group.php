            ...
            <div class="section">
              <form class="form-searchGroup" onsubmit="return submitFrmSearch(this);">
                <?php if($btnaspma){?>
                  ...
                  <div class="col-sm-1">
                    <button rel="1" type="button" class="btn btn-primary btn-block" onclick="clicktorequestaction('reportgroup',this)"><?php echo $Array_Lang["bt:Report"][$_SESSION['Session_Admin_Language']]?></button>
                  </div>
                  <div class="col-sm-1">&nbsp;</div>
                <?php }else{?>
                  <div class="col-sm-6">&nbsp;</div>
                <?php }?>
                <div class="col-md-3 hidden"><input id="fooFilter" type="text" class="form-control text-left" placeholder="Enter Table Filter Criteria Here..."></div>
                <div class="col-md-2 hidden"><button name="searchGroupsubmit" type="submit" class="btn btn-hover btn-primary btn-block">Search</button></div>
                <div class="col-md-1 hidden"><button name="searchGroupclear" type="button" class="btn btn-hover btn-primary btn-block">Clear</button></div>
              </form>
            </div>
          </div>
        ...
        <div class="panel-body">
          <div class="section">
            <form class="form-search" name="ListSearchForm" id="ListSearchForm" method="post" onsubmit="return submitListFrmSearch(this);">
              <?php if($btnaspma){?>
                <div class="col-sm-1"><button rel="1" type="button" class="btn btn-danger btn-block" onclick="clicktodeletelist(this)"><?php echo $Array_Lang["bt:Delete"][$_SESSION['Session_Admin_Language']]?></button></div>
                <div class="col-md-1"><button rel="1" type="button" class="btn btn-primary btn-block" onClick="clicktoexportinfo(this)"><?php echo $Array_Lang["bt:Export"][$_SESSION['Session_Admin_Language']]?></button></div>
              <?php }?>
              ...
              echo '</div>';
              ?>
              <div class="col-md-2"><input id="ListFilter" type="text" class="form-control text-left" placeholder="<?php echo $Array_Lang["txt:Search Keyword"][$_SESSION['Session_Admin_Language']]?>"></div>
