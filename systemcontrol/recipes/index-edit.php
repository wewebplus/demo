...
foreach($systemLang as $lkey=>$lval){
	...
	$arrf[] = $lkey."."._TABLE_RECIPES_DETAIL_."_By AS By".$lkey;
}
      ...
      <div class="panel-body bg-light">
        ...
        <div class="section-divider mb40" id="spy2">
            <span><?php echo $Array_Mod_Lang["txt:Head 02"][$_SESSION['Session_Admin_Language']]?></span>
					...
					<div class="paneltabbody">
						<div class="tab-content tab-validate pn br-n">
					        ...
					        <input name="<?php echo "detailid".$lkey?>" type="hidden" value="<?php echo $SubjectID; ?>" />
									...
									?>
									<div class="row">
										<div class="col-md-12"><h5><?php echo $Array_Mod_Lang["txtinput:inputSubject"][$_SESSION['Session_Admin_Language']]." ".($countlang>1?"( ".$lval." Language )":"");?> <span class="text-danger mn">*</span></h5></div>
									</div>
					        <div class="row">
				            <div class="col-md-12">
				                <div class="section">
									...
									<div class="row">
										<div class="col-md-12"><h5><?php echo $Array_Mod_Lang["txtinput:inputTitle"][$_SESSION['Session_Admin_Language']]." ".($countlang>1?"( ".$lval." Language )":"");?> <span class="text-danger mn">*</span></h5></div>
									</div>
					        <div class="row">
					          <div class="col-md-12">
					            <div class="section">
					        ...
					        echo '<div class="row">';
					          echo '<div class="col-md-12">';
					            echo '<h5>'.$Array_Mod_Lang["txtinput:inputDetail"][$_SESSION['Session_Admin_Language']].'</h5>';
					          echo '</div>';
					        echo '</div>';
					        echo '<div class="row">';
					          echo '<div class="col-md-12">';
							...
							<div class="form-group">
								...
								<div class="bs-component">
									<?php
									echo '<input type="text" name="inputFitPeople'.$lkey.'" class="form-control" value="'.$Row['FitPeople'.$lkey].'" required data-msg-required="'.$Array_Mod_Lang["txt:FitPeople"][$_SESSION['Session_Admin_Language']].' '.($countlang>1?"( ".$lval." Language )":"").'" placeholder="'.$Array_Mod_Lang["txt:FitPeople"][$_SESSION['Session_Admin_Language']].' '.($countlang>1?"( ".$lval." Language )":"").'">';
									?>
								</div>
							...
							<div class="form-group">
								...
								<div class="bs-component">
									<?php
									$PreparationTime = $Row['PreparationTime'.$lkey];
							...
							<div class="form-group">
								...
								<?php
								$Difficulty = $Row['Difficulty'.$lkey];
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<div class="bs-component">
										<?php
										echo '<input type="text" name="inputYoutubeKey'.$lkey.'" class="form-control" value="'.$Row['YoutubeKey'.$lkey].'" required data-msg-required="'.$Array_Mod_Lang["txt:YoutubeKey"][$_SESSION['Session_Admin_Language']].' '.($countlang>1?"( ".$lval." Language )":"").'" placeholder="'.$Array_Mod_Lang["txt:YoutubeKey"][$_SESSION['Session_Admin_Language']].' '.($countlang>1?"( ".$lval." Language )":"").'">';
										?>
									</div>
							...
							echo '<div id="boxRecipe'.$lkey.'" class="listarea">';
								if($RecordCountRelate>0){
									foreach($ArrRelate as $KRelate=>$RowRelate){
										...
										$_DivID = ($KRelate>0?'Clone_boxRecipe'.$lkey.'_'.$KRelate:'boxRecipe'.$lkey.'Master');
										echo '<div id="'.$_DivID.'" class="'.($KRelate>0?'listitem item clone':'listitem').'">';
											echo '<input type="hidden" name="inputRecipeDataID'.$lkey.'[]" value="'.$_ID.'" />';
											echo '<div class="form-group">';
												echo '<label class="col-lg-2 control-label">Step '.($KRelate+1).'</label>';
												echo '<div class="col-lg-8">';
													echo '<textarea name="inputRecipeItem'.$lkey.'[]" class="gui-textarea" rows="3">'.$_Detail.'</textarea>';
												echo '</div>';
				...
				<div class="section-divider mb40 mt40" id="spy3">
						...
						<div class="docs-buttons">
							...
							<div class="btn-group btn-group-crop">
								<button class="btn btn-primary btn-sm" data-method="getCroppedCanvas" type="button">
									<span class="docs-tooltip" data-toggle="tooltip" title="$().cropper(&quot;getCroppedCanvas&quot;)">Get Image</span>
								</button>
							</div>
              ...
              <input name="DataH" type="hidden" value="<?php echo $defaultdata[$Login_MenuID]["img"]["H"];?>" />
					...
					<div class="panel-body pn">
						<div class="row table-layout table-clear-xs">
							...
							<div class="col-xs-3 bg-light br-l br-grey va-t pv10">
								<div class="clearfix">
