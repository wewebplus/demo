...
$arrf[] = "a."._TABLE_RECIPES_GROUP_.'_Status AS status';
$arrf[] = "a."._TABLE_RECIPES_GROUP_.'_Ignore AS allignore';
foreach($systemLang as $lkey=>$lval){
  ...
  $arrf[] = $lkey."."._TABLE_RECIPES_GROUP_DETAIL_."_Title AS Title".$lkey;
...
$sql .= " WHERE "._TABLE_RECIPES_GROUP_."_ID = ".(int)$itemid;
$z = new __webctrl;
$z->sql($sql);
$v = $z->row();
$Row = $v[0];
