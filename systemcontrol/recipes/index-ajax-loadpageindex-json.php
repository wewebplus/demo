...
$sql .= "("	;
	...
	$arrf[] = "a."._TABLE_RECIPES_."_GID AS GroupID";
  ...
  $arrf[] = "a."._TABLE_RECIPES_."_Public AS ListPublic";
  $arrf[] = "a."._TABLE_RECIPES_."_View AS ListCountView";
  $arrf[] = "a."._TABLE_RECIPES_."_Comment AS ListCountComment";
  $arrf[] = $langkey."."._TABLE_RECIPES_DETAIL_."_ID AS SubjectID".$langkey;
	$arrf[] = $langkey."."._TABLE_RECIPES_DETAIL_."_Subject AS Subject".$langkey;
	$arrf[] = $langkey."."._TABLE_RECIPES_DETAIL_."_Status AS Status".$langkey;
	$sql .= "SELECT  ".implode(',',$arrf)." FROM "._TABLE_RECIPES_." a";
  $sql .= " LEFT JOIN (";
    $arrjoinlang = array();
    $arrjoinlang[] = _TABLE_RECIPES_DETAIL_."_ID";
    $arrjoinlang[] = _TABLE_RECIPES_DETAIL_."_ContentID";
    $arrjoinlang[] = _TABLE_RECIPES_DETAIL_."_Subject";
    $arrjoinlang[] = _TABLE_RECIPES_DETAIL_."_Status";
    $sql .= "SELECT ".implode(',',$arrjoinlang)." FROM "._TABLE_RECIPES_DETAIL_;
    $sql .= " WHERE "._TABLE_RECIPES_DETAIL_."_Lang = '".$langkey."'";
    unset($arrjoinlang);
  $sql .= ") ".$langkey." ON (a."._TABLE_RECIPES_."_ID = ".$langkey."."._TABLE_RECIPES_DETAIL_."_ContentID)";
