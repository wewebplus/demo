...
$sql .= "("	;
  ...
  $sql .= " WHERE "._TABLE_WEBLINK_GROUP_."_Folder = '".$ModuleKey."'";
  unset($ArrInnerField);
$sql .= ") TBmain";
$sql .= " LEFT JOIN (";
  $sql .= "SELECT * FROM ";
  $sql .= "(";
    ...
    $arrinnercount[] = _TABLE_WEBLINK_."_GroupID AS JoinContentID";
    $sql .= "SELECT ".implode(',',$arrinnercount)." FROM "._TABLE_WEBLINK_." WHERE 1 GROUP BY "._TABLE_WEBLINK_."_GroupID";
    unset($arrinnercount);
  $sql .= ") TBCount";
