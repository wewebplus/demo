...
$PathUploadFile = str_replace("ProductsPending","memberProduct",$PathUploadFile);
							...
							<div class="BoxGallery">
								...
								if($RecordCountFile>0) {
								    ...
								    if(is_file($FilePathLogoFromDB)) {
											...
											echo '<a class="fancybox Img" rel="gallery1" href="'.$URLFile.'"><img src="'.$URLFile.'" /></a>';
										}
									}
								}
								?>
					...
					<div class="col-md-10 mt10">
						<div class="bs-component">
							...
							if($RecordCountFile>0) {
							    ...
							    $datadwn = "downloadsrc.php?".encode_URL('Login_MenuID='.$Login_MenuID.'&itemid='.$ID);
							    if(is_file($FilePathLogoFromDB)) {
										$URLFile = str_replace(_RELATIVE_PATH_UPLOAD_,_HTTP_PATH_UPLOAD_,$FilePathLogoFromDB);
										echo '<div><a href="'.$datadwn.'" target="_blank"><img src="'.$FullpathFilePath.'"></a></div>';
									}else{
